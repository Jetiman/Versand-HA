# DHL Paketverfolgung für Home Assistant

Zeigt den Status aller aktiven DHL-Sendungen deines DHL-Kontos als Sensoren in Home Assistant an – automatisch, ohne dass du Trackingnummern manuell eintragen musst. Genau wie die DHL-App zeigt sie alle Sendungen an, die in deinem Konto hinterlegt sind.

Diese Integration nutzt den gleichen (inoffiziellen) Login- und Abfrage-Mechanismus wie die DHL Paket App. Die Herangehensweise orientiert sich an [ioBroker.parcel](https://github.com/TA2k/ioBroker.parcel).
...
3. „DHL Paketverfolgung“ in HACS suchen und installieren.
...
1. **Einstellungen → Geräte & Dienste → Integration hinzufügen → „DHL Paketverfolgung“**.
...
- Nur DHL (kein Multi-Carrier-Support wie bei ioBroker.parcel).
